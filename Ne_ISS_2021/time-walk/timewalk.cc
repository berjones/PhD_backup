...
void p_recoil(){
    ...
    infile = new TFile("/media/ben/TOSHIBA_brj/Ne_ISS_2021/my_data/22Ne_R8_to_R15_sumhists_20230622_004428_Al_deadlayer_0004_arraydist_129p1_alpha_recalibrated.root" ); //read in input file
    ofstream outfile("p-recoil_timewalk2.cal" ); //open outfile
...
void nside_pside(){
    ...
    TFile *infile = new TFile( "/media/ben/TOSHIBA_brj/Ne_ISS_2021/my_data/R8_to_R15_sum_events.root" ); //read in file
    ofstream outfile( "pn_timewalk_new2.cal" ); //open outfile
