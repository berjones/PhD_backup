...
void plot_Ex_vs_z(const std::string& hdtv_file, const std::string& zfile, const std::string& theta_file, const std::string& eff_file, double real_Ex, int index, TLegend* legend, const std::string& params){
    ...
    std::string plot_label = "Ex_vs_z_residual_" + params;
    ...
    if (output_file.is_open()) {
        ...
        output_file << params << " " << real_Ex << " " << m << " " << m_err << " " << c << " " << c_err << "\n";
...
void run_Ex_vs_z(const std::string& params) {
    ...
    for (int fitIndex = 0; fitIndex < 3; ++fitIndex) {
        ...
        plot_Ex_vs_z(hdtvFile, zFile, thetaFile, effFile, energy, fitIndex, legend, params);
    ...
    std::string image_label = "Plots/Ex_vs_z_residual_" + params + ".png";
