...
void run_fits(){
    ...
    double IN = 1071.1129381481983;

    // Fit the ground state 
    double E0 = 0;
    double L0 = 2;
    ptolemy_fit_1_state("ptolemy_clean/22Ne_2022_E_0.out-clean", "hdtv_fits/hdtv_E0-clean.txt", "theta_z/z_values.dat", "theta_z/theta_values_E0.dat", "projections/Eff_proj_onoff.dat", "Ne_1967_diffcross/abso_0.txt", IN, E0, L0);

    double E1016 = 1016;
    double L1016 = 0;
    ptolemy_fit_1_state("ptolemy_clean/22Ne_2022_E_1016.out-clean", "hdtv_fits/hdtv_E1016-clean.txt", "theta_z/z_values.dat", "theta_z/theta_values_E1016.dat", "projections/Eff_proj_onoff.dat", "Ne_1967_diffcross/abso_1016.txt",IN, E1016, L1016); 

    double E2315 = 2315;
    double L2315 = 2;
    ptolemy_fit_1_state("ptolemy_clean/22Ne_2022_E_2315.out-clean", "hdtv_fits/hdtv_E2315-clean.txt", "theta_z/z_values.dat", "theta_z/theta_values_E2315.dat", "projections/Eff_proj_onoff.dat", "Ne_1967_diffcross/abso_2315.txt",IN, E2315, L2315);  

    double E3220 = 3220;
    double L3220 = 1;
    ptolemy_fit_1_state("ptolemy_clean/22Ne_2022_E_3220.out-clean", "hdtv_fits/hdtv_E3220-clean.txt", "theta_z/z_values.dat", "theta_z/theta_values_E3220.dat", "projections/Eff_proj_onoff.dat", "Ne_1967_diffcross/abso_3220.txt",IN, E3220, L3220); 

    double E3431 = 3431;
    double L3431 = 2;
    ptolemy_fit_1_state("ptolemy_clean/22Ne_2022_E_3431.out-clean", "hdtv_fits/hdtv_E3431-clean.txt", "theta_z/z_values.dat", "theta_z/theta_values_E3431.dat", "projections/Eff_proj_onoff.dat", "Ne_1967_diffcross/abso_3431.txt",IN, E3431, L3431); 

    double E3836 = 3836;
    double L3836 = 1;
    ptolemy_fit_1_state("ptolemy_clean/22Ne_2022_E_3836.out-clean", "hdtv_fits/hdtv_E3836-clean.txt", "theta_z/z_values.dat", "theta_z/theta_values_E3836.dat", "projections/Eff_proj_onoff.dat", "Ne_1967_diffcross/dummy.txt",IN, E3836, L3836); 

    double E3987 = 3987;
    double L3987 = 2;
    ptolemy_fit_1_state("ptolemy_clean/22Ne_2022_E_3987.out-clean", "hdtv_fits/hdtv_E3987-clean.txt", "theta_z/z_values.dat", "theta_z/theta_values_E3987.dat", "projections/Eff_proj_onoff.dat", "Ne_1967_diffcross/dummy.txt",IN, E3987, L3987); 
...
void plot_Ex_vs_z(const std::string& hdtv_file, const std::string& zfile, const std::string& theta_file, const std::string& eff_file, double real_Ex, int index, TLegend* legend){
    ...
    if (index == 0) {
        EXP_data->Draw("APL");
        EXP_data->GetXaxis()->SetLimits(-600, -200);
        EXP_data->GetYaxis()->SetRangeUser(-70, 70);
        f1->Draw("same");
    }
    else {
...
void run_Ex_vs_z() {
    ...
    for (int fitIndex = 0; fitIndex < 7; ++fitIndex) {
        ...
        switch (fitIndex) {
            ...
            case 5:
                energy = 3836;
                hdtvFile = "hdtv_fits/hdtv_E3836-clean.txt";
                thetaFile = "theta_z/theta_values_E3836.dat";
                break;
            case 6:
                energy = 3987;
                hdtvFile = "hdtv_fits/hdtv_E3987-clean.txt";
                thetaFile = "theta_z/theta_values_E3987.dat";
                break;
            default:
...
void print_map(){
    FileReader Experimental_yields("hdtv_fits/hdtv_E0-clean.txt", "theta_z/z_values.dat", "theta_z/theta_values_E0.dat", "projections/Eff_proj_onoff.dat");
