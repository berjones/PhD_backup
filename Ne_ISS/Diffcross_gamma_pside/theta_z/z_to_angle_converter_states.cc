...
void z_to_theta_run(double E_x) {
    z_to_angle_conveter("reaction_22Ne_R14_to_R45_array-recoil200.dat");
    ...
    std::string theta_filename =  Form("theta_values_E%d.dat", E_x_int); 
    std::ofstream theta_outfile(theta_filename.c_str());
